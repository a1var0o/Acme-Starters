...
<acme:list navigable = "true">
	...
	<acme:list-column code="auditor.audit-section.list.label.notes" path="notes" width="25%"/>
	<acme:list-column code="auditor.audit-section.list.label.hours" path="hours" width="25%"/>
