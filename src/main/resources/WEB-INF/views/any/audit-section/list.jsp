...
<acme:list navigable="true">
	<acme:list-column code="any.audit-section.list.label.name" path="name" width="10%"/>
	<acme:list-column code="any.audit-section.list.label.description" path="notes" width="50%"/>
