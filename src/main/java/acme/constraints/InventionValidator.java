	...
	public boolean isValid(final Invention invention, final ConstraintValidatorContext context) {
		...
		if (invention == null)
			...
			}
			{
				...
				validInterval = invention.getDraftMode() || //
					invention.getStartMoment() != null && invention.getEndMoment() != null && //
						MomentHelper.isBefore(invention.getStartMoment(), invention.getEndMoment());
